...
#define LOG_TAG "android.hardware.light@2.0-service.tone"
...
const static std::string kRedRampStepMsPath = "/sys/class/leds/red/step_duration";
const static std::string kGreenRampStepMsPath = "/sys/class/leds/green/step_duration";
const static std::string kBlueRampStepMsPath = "/sys/class/leds/blue/step_duration";
